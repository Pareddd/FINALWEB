...
<body class="antialiased bg-slate-900 text-white overflow-x-hidden">
            ...
            <div class="flex justify-between items-center h-20">
                ...
                <div class="hidden md:flex items-center space-x-6">
                    @auth
                        ...
                        @else
                            <a href="{{ route('dashboard') }}" class="text-gray-300 hover:text-white font-bold">MY TICKETS</a>
                        @endif
                    @else
    ...
    <div class="pt-32 pb-20">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            @if(session('success'))
                <div class="mb-6 bg-green-500/20 border border-green-500 text-green-400 px-4 py-3 rounded relative" role="alert">
                    <strong class="font-bold">Sukses!</strong> {{ session('success') }}
                </div>
            @endif
            @if(session('error'))
                <div class="mb-6 bg-red-500/20 border border-red-500 text-red-400 px-4 py-3 rounded relative" role="alert">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="bg-slate-900 border border-white/10 rounded-xl p-5 flex flex-col md:flex-row justify-between items-center hover:border-fuchsia-500/50 transition duration-300 group">
                                <div class="mb-4 md:mb-0 w-full md:w-auto">
                                    ...
                                    <p class="text-2xl font-display font-bold text-white mt-1">IDR {{ number_format($ticket->harga, 0, ',', '.') }}</p>
    ...
    <footer class="bg-black border-t border-white/10 py-8 mt-12">
        <div class="max-w-7xl mx-auto px-4 text-center">
            <p class="text-gray-500 text-sm">&copy; {{ date('Y') }} SoundStage. All rights reserved.</p>
        </div>
    </footer>
